...
var DrawingVector = function () {
  ...
  _createClass(DrawingVector, [{
    ...
    value: function draw(playground) {
      ...
      var unitY = playground.unitVectorY;
      ...
      var translatedVector = this.v.multiplyNew(unitVector);
...
ready(function () {
  ...
  var va = new _DrawingVector2.default(1, -2, _colours2.default[0]);
  var vb = new _DrawingVector2.default(-3, 1, _colours2.default[1]);
